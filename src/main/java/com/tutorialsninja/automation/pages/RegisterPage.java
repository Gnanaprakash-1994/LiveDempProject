...
public class RegisterPage {
	...
	@FindBy(css="div:nth-of-type(2) > .col-sm-10 > .text-danger")
	...
	@FindBy(css="div#account-register > .alert.alert-danger.alert-dismissible")
	public static WebElement mainWarning ;
	
	@FindBy(css="label:nth-of-type(1) > input[name='newsletter']")
